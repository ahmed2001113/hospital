...
class GroupInvoices extends Component
{
    ...
    public $catchError;
    public $price = 0;
    public $patient_id,$doctor_id,$section_id,$section_id2,$type,$Service_id2,$Service_id;
    ...
    public function get_section()
    {
        ...
        $this->section_id2 = $doctor_id->section->name_en;
    }
        ...
        if($this->type == 1){
            ...
            try {
                ...
                if($this->updateMode){
                    ...
                    if($this->section_id){
                        $group_invoices->section_id = DB::table('sections')->where('name', $this->section_id)->first()->id;
                    }
                    else{
                        $group_invoices->section_id = DB::table('sections')->where('name', $this->section_id2)->first()->id;
                    }
...
//----------------------------------------------------------------------------------------------------
    ...
    public function edit($id){
        ...
        $this->section_id = DB::table('sections')->where('id', $group_invoices->section_id)->first()->name;
        $this->section_id2 = DB::table('sections')->where('id', $group_invoices->section_id)->first()->name_en;;
    ...
    public function print($id)
    {
        ...
        return Redirect::route('group_Print_single_invoices',[
            ...
            'section_id2' => $single_invoice->Section->name_en,
            'patient_id' => $single_invoice->Patient->name,
            'Group_id' => $single_invoice->Group->name,
            'Group_id2' => $single_invoice->Group->name_en,
