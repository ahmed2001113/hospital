...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{trans('patients.operation')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{trans('patients.xrays')}}</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                                    ...
                                    <div class="table-responsive">
                                        <table style="text-align: center" class="table text-md-nowrap" id="example1">
                                            ...
                                            <tr>
                                                ...
                                                <th>{{trans('patients.27')}}</th>
                                                <th>{{trans('patients.28')}}</th>
                                           ...
                                           @foreach($rays as $ray)
                                               <tr>
                                                   ...
                                                   <td>
                                                       ...
                                                       <a class="btn btn-primary btn-sm" href="{{route('rays.view',$ray->id)}}" role="button">{{trans('patients.26')}}</a>
                                                       @endif
                                                   </td>
                                               </tr>
                                           @endforeach
