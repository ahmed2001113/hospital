...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{trans('payment.calculations')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{trans('payment.payment')}}</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                                ...
                                <div class="card-header pb-0">
                                    <div class="d-flex justify-content-between">
                                        <a href="{{route('Payment.create')}}" class="btn btn-primary" role="button"
                                           aria-pressed="true">{{trans('payment.add_new')}}</a>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table text-md-nowrap" id="example1">
                                            ...
                                            <tr>
                                                ...
                                                <th>{{trans('payment.price')}}</th>
                                                <th>{{trans('payment.statement')}}</th>
                                                <th>{{trans('payment.date')}} </th>
                                                <th>{{trans('payment.operation')}}</th>
                                            </tr>
                                            </thead>
                                            <tbody>
