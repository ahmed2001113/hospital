...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{trans('Dashboard/labEmployee.2')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{trans('Dashboard/labEmployee.1')}}</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table style="text-align: center" class="table text-md-nowrap" id="example1">
                                            ...
                                            <tr>
                                                <th>#</th>
                                                <th>{{trans('Dashboard/labEmployee.4')}}</th>
                                                <th>{{trans('Dashboard/labEmployee.5')}}</th>
                                                <th>{{trans('Dashboard/labEmployee.6')}}</th>
                                                <th>{{trans('Dashboard/labEmployee.7')}}</th>
