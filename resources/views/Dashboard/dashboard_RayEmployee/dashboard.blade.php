...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="left-content">
						<div>
						  <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">{{trans('x_ray_emp/index.dashboard')}}</h2><br>
						  <p class="mg-b-0">{{trans('x_ray_emp/index.welcome')}}  {{auth()->user()->name}}</p>
						</div>
					</div>
				</div>
				<!-- /breadcrumb -->
