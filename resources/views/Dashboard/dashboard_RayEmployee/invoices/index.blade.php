...
@endsection
@section('title')
{{trans('x_ray_emp/index.examinations')}}
@stop
...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{trans('x_ray_emp/index.examinations')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{trans('x_ray_emp/index.invoices')}}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                    ...
                    <div class="table-responsive">
                        <table class="table text-md-nowrap" id="example1">
                            ...
                            <tr>
                                ...
                                {{-- <th>{{trans('x_ray_emp/index.invoices')}}</th> --}}
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu tx-13">
                                                <a class="dropdown-item" href="{{route('invoices_ray_employee.edit',$invoice->id)}}"><i class="text-primary fa fa-stethoscope"></i>&nbsp;&nbsp; {{trans('x_ray_emp/index.diagnosis')}}</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
