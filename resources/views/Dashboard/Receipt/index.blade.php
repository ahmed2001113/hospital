...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">    {{trans('receipt.calculations')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/  {{trans('receipt.receipt')}} </span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                                ...
                                <div class="card-header pb-0">
                                    <div class="d-flex justify-content-between">
                                        <a href="{{route('Receipt.create')}}" class="btn btn-primary" role="button"
                                           aria-pressed="true">{{trans('receipt.add_new')}}</a>
                                    </div>
                                </div>
                                <div class="card-body">
