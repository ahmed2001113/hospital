                ...
                <div class="card-body">
                    <form action="{{ route('Doctors.update', 'test') }}" method="post" autocomplete="off"
                        ...
                        <div class="pd-30 pd-sm-40 bg-gray-200">
                            ...
                            @else
                            <option
                            value="{{$section->id}}" {{$section->id == $doctor->section_id ? 'selected':"" }}>{{$section->name_en}}</option>
                            @endif
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class=" row row-xs align-items-center mg-b-20">
                                ...
                                @else
                                <option value="{{$appointment->id}}" {{ in_array($appointment->id, $check) ? 'selected' : '' }}>{{$appointment->name_en}}</option>
                                @endif
                                        @endforeach
                                    </select>
                                </div>
