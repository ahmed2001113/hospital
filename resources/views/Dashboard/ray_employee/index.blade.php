...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{trans('ray_emp.x_ray')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{trans('ray_emp.emp')}}</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table style="text-align: center" class="table text-md-nowrap" id="example1">
                                            ...
                                            <tr>
                                                <th>#</th>
                                                <th>{{trans('ray_emp.name')}}</th>
                                                <th>{{trans('ray_emp.email')}}</th>
                                                <th>{{trans('ray_emp.add_new')}}</th>
                                                <th>{{trans('ray_emp.operation')}} </th>
