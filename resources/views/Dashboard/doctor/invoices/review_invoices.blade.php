...
@section('title')
{{trans('doctor/sidebar.list_of_reviews')}}
@stop
@section('css')
...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{trans('doctor/sidebar.list_of_reviews')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{trans('doctor/sidebar.invoices')}}</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                                    ...
                                    <div class="table-responsive">
                                        <table class="table text-md-nowrap" id="example1">
                                            ...
                                            <tr>
                                                ...
                                                <th>{{trans('doctor/sidebar.review_date')}}</th>
                                           ...
                                           @foreach($invoices as $invoice)
                                               <tr>
                                                   ...
                                                   <td>{{App\Models\Diagnostic::where(['invoice_id' => $invoice->id])->first()->date}}</td>
                                                   <td>
                                                    <div class="dropdown">
