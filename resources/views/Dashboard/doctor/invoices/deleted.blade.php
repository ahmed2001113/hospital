<!-- Deleted insurance -->
<div class="modal fade" id="deleted{{$patient_ray->id}}" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{trans('doctor/sidebar.delete_xray')}}</h5>
            ...
            <div class="modal-body">
                <form action="{{ route('rays.destroy', $patient_ray->id) }}" method="post">
                    ...
                    <div class="row">
                        <div class="col">
                            <p class="h5 text-danger">{{trans('doctor/sidebar.delete_xray')}}</p>
