...
//---------------------------------------------------------------------------------------------------------------
    ...
    //############################# end sections route ######################################
     ...
     //############################# Doctors route ##########################################
        ...
        Route::put('appointment/approval/{id}',[AppointmentController::class,'approval'])->name('appointment.approval');
        Route::get('appointment/approval',[AppointmentController::class,'index2'])->name('appointment.index2');
